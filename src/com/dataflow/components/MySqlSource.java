...
public class MySqlSource implements SourceInterface{
    ...
    public MySqlSource() {
        this.refId = "DataFlow.MySqlSource";
        this.classId = "MySqlSource";
    }

    public MySqlSource(String connectionManagerRefId, String tableName) {
        this();
